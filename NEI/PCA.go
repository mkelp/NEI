...
func main() {
	...
	ff, err := os.Open("/home/mkelp/work/src/NEI/spatialResults_mkelp_test_afdust.ncf")
	f, err := cdf.Open(ff)
	if err != nil {
		panic(err)
	}
	...
	ff2, err := os.Open("/home/mkelp/work/src/NEI/index_numbers_test_afdust.csv")
	if err != nil {
		panic(err)
	}
	r := csv.NewReader(ff2)
	...
	hi := mat64.NewDense(50105, 23, data2)
	...
	proj.Mul(hi, vecs.View(0, 0, 23, k))
